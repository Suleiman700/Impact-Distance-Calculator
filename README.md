...
## 🛡️ The Context
Developed in a war zone, this tool solves a specific problem: **uncertainty.** By measuring the time between the visual flash of an explosion and the audible boom, we can apply physics to determine exactly how far away the event occurred. 

> "We often see missiles explode and think they are right on top of us. After calculating, we often realize they are miles away."
...
*   **Global History Map:** A comprehensive view of all recorded impacts.
...
1.  **Sight:** The moment you see the flash or impact, tap the **Target Button**.
2.  **Sound:** Tap again when you hear the sound of the explosion.
3.  **Calculate:** The app automatically calculates the distance based on the duration.
4.  **Save & Analyze:** The record is saved to your history with your current GPS coordinates, heading, and tilt.
...
*   **Sensors:** Expo-Location, Expo-Sensors (Heading/Tilt)
...
## 📬 Contact & Support
Developed by **BrightPixel**.
*   **Website:** [brightpixel.work](http://brightpixel.work/)
*   **GitHub:** [Suleiman700](https://github.com/Suleiman700)
*   **Email:** brightpixelwork@gmail.com

---
*Disclaimer: This app is a hobby tool for distance estimation. Always prioritize official civil defense instructions and seek shelter during active alerts.*
